...
<div class="checkout-wrap">
	...
	<div >
    <ul class="checkout-bar" style ="margin-top:60px">
    ...
    <div class="clearfix"></div>
    <div class="survey-employee-info" style ="margin-top:60px">
    ...
    var next = function(){
        ...
        if(step > {{$questions->count()}}){
            ...
            if(insurance_payor == 1){                
                ...
                console.log(answers);
                $.ajax({
                    url: '{{route("admin::review::save",["employee"=>$employee->id])}}',
                    type: 'post',
                    dataType: 'json',
                ...
                .done(function() {
                    if(isSend == 1)
                        location.href = "/admin/review/comment";
                    else
                        location.href = "/admin/review/complete";
                })
                .fail(function() {
                    console.log("error");
                })
