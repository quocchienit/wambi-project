                            ...
                            <div class="block-display">
                                ...
                                <div class="from-who block-space">
                                    <label style="font-weight: normal" for="">From:</label><input id="from" name="from"
                                                                                                  class="placeholder-style"
                                                                                                  type="text"
                                                                                                  placeholder="One Grateful Patient">
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-left">
                        ...
                        <select id="select_tag" required class="form-control select2" multiple="multiple"
                                style="width: 100%">
                            @foreach($speciality as $item)
                                <option value="{{ $item->id }}"
                                        style="text-transform: capitalize;">{{ strtolower($item->name) }}</option>
                            @endforeach
                        </select>
                    </div>
                    <br>
                    <button id="btn-submit-tag" class="btn pull-right"
                            style="background-color: #F71749; color: #ffffff;">Submit
                    </button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="send-line" style="margin-top: 15px; margin-left: 10px;">Send your Carepostcard by
                        entering your email
                    </div>
                    <div class="form-group">
                        <p style="color: #F71749; margin-right: 10px;" class="text-right">Required*</p>
                        <input required type="email" id="email" class="form-control modal-email" name="email" value=""
                    ...
                    <div class="form-group">
                        <input type="email" id="provider_email" class="form-control" name="provider_email" value=""
