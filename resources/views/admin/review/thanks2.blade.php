...
<div class="row comment-new"  style ="margin-top:60px">
    ...
    <div class="col-md-6 col-xs-12" style="border-left: 2px solid #0099FF">
        <div class="skip hidden-desktop">
            <a href="/admin/review/thanks-completed"><span>Skip</span> <i class="ion-arrow-right-c"></i></a>
        </div>
...
Thank you for providing me with compassionate care. I am grateful for your kind approach and gentles. You are very special to our family.">{!! old('content') !!}</textarea>
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-5 center-content">
                        <div class="block-display">
                            <img src="{{ url('http://carepostcards.com/storage/media/stamp-icon-1491150043.png') }}" alt="" class="heart-letter">
                            ...
                            <div class="from-who block-space">
                                <label style="font-weight: normal" for="">From:</label><input id="from" name="from" class="placeholder-style" type="text" placeholder="One Grateful Patient" value="">
                            </div>
                        </div>
                    </div>
