...
<div class="row comment-new">
    <div class="col-md-6 col-xs-12">
        ...
        </div><div class="button_and_or hidden-xs hidden-sm">
    ...
    <div class="col-md-6 col-xs-12" style="border-left: 2px solid #0099FF">
...
Thank you for providing me with compassionate care. I am grateful for your kind approach and gentles. You are very special to our family.">{!! old('content') !!}</textarea>
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-5 center-content">
                        <div class="block-display">
                            <img src="{{ url('http://dev.carepostcards.com/storage/media/stamp-icon-1491150043.png') }}" alt="" class="heart-letter">
                            <div class="doctor-name block-space" style="text-transform: capitalize;">
                                <label style="font-weight: normal" for="">To: </label><input readonly id="to" name="to" class="placeholder-style" type="text" placeholder="Shirley Simmons" value="{{ $employee?$employee->firstname:'' }} {{ $employee?$employee->lastname:'' }}">
                            </div>
                            ...
                            <div class="from-who block-space">
                                <label style="font-weight: normal" for="">From:</label><input id="from" name="from" class="placeholder-style" type="text" placeholder="One Grateful Patient">
                            </div>
                        </div>
                    </div>
                    <div class="date-display" style="text-transform: capitalize;">{{ gmdate("F j, Y", time()) }}</div>
                </div>
                <div class="form-group comment-footer-2">
                    <div class="footer-content">
                        <p>*This Carepostcard will be <b>posted publically</b> on carepostcard.com</p>
                    </div>
                    <a href="javascript:void(0)" class="btn btn-primary waves-effect waves-light btn-step1-submit" type="submit">@lang('survey.SUBMIT')</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Thanks! Tell us a little bit more about provider</h4>
            </div>
            <div class="modal-body">
                <div class="text-left">
                    <h4 style="color: #F71749;">Tags</h4>
                    <p>Include <i>at least</i> 1 tag that describes the type of care you received.</p>
                    <p style="color: #F71749" class="text-right">Required*</p>
                    <select id="select_tag" required class="form-control select2" multiple="multiple" style="width: 100%">
                        @foreach($speciality as $item)
                            <option value="{{ $item->id }}" style="text-transform: capitalize;">{{ strtolower($item->name) }}</option>
                        @endforeach
                    </select>
                </div>
                <br>
                <button id="btn-submit-tag" class="btn pull-right" style="background-color: #F71749; color: #ffffff;">Submit</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="send-line" style="margin-top: 15px; margin-left: 10px;">Send your Carepostcard by entering your email</div>
                <div class="form-group">
                    <p style="color: #F71749; margin-right: 10px;" class="text-right">Required*</p>
                    <input required type="email" id="email" class="form-control modal-email" name="email" value="" placeholder="Email address">
                </div>

                <div class="send-line">
                    Know your provider's email?<br>
                    <i>Enter it in our address book so we can send it to them</i>
                </div>
                <div class="form-group">
                    <input type="email" id="provider_email" class="form-control" name="provider_email" value="" placeholder="Provider's email address">
                </div>
                ...
                <div class="term-condition">
                    ...
                    <p class="accept-text">I accept <a class="term-of-user" href="#" data-toggle="modal" data-target="#term-modal">Terms of Service</a> and have read the <a class="privacy-policy-button" href="#" data-toggle="modal" data-target="#privacy-modal">Privacy policy</a></p>
                </div>
                <a href="javascript:void(0)" id="btnSave" class="submit-button buttonload" style="padding: 8px;"><i style="display: none;" id="buttonloading" class="fa fa-spinner fa-spin"></i> Send</a>
            </div>
        </div>
    </div>
</div>
