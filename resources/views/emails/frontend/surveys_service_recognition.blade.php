<p>{{$employee->name()}} received {{$configPeck->number_of_consecutive}} perfect reviews in a row and is on a Wambi Hot Streak!</p>
<p>Take this opportunity to recognize {{$employee->firstname}} in-person with a high-five or you can Award {{$employee->firstname}} with Pecks for providing exceptional care. </p>
<p>Login: {{url('admin')}}</p>
<p>	</p>
<p>Peck Yeah!</p>
<p>Your Wambi Team</p>
